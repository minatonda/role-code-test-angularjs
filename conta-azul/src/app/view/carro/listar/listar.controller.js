(function () {
    ...
    angular
        .module('carro.listar.controller', [])
        .controller('CarroListarController', CarroListarController);

    /** @ngInject */
    function CarroListarController(DctvTabelaFactory, DadosService, ModuloService, lodash) {
